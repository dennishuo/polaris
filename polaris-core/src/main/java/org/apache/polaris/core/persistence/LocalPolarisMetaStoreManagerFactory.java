...
import org.apache.polaris.core.persistence.NonTransactionalMetaStoreManager;
...
public abstract class LocalPolarisMetaStoreManagerFactory<StoreType>
  ...
  private void initializeForRealm(
    ...
    PolarisMetaStoreManager metaStoreManager = new NonTransactionalMetaStoreManager();
